...
def usage():
	print '---------------------------------------------------'
	print 'Kullanim:'
        print '#Windows: THT.py http://www.siteurl.com/'
        print '#Linux: python THT.py http://www.siteurl.com/'
	print "\a"
print \
"""                                                                                                                                          
  _____           _    _   _            _    _____                    
...
#TurkHackTeam Distributed Denial of Service attack Script
"""
print '---------------------------------------------------'
